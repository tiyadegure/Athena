...
echo ""
echo "NFT Contract (ERC-1155): 0x4F541D6f6249deAE5cDa2B00625d6933E4943b3c"
...
echo ""
echo "NFT Tiers (v7 - Seed-based + OpenRarity):"
echo "  Rarity >= 30 → Rainbow gradient + Dynamic aura"
echo "  Rarity >= 25 → Gold Athena"
echo "  Rarity >= 20 → Silver Athena"
echo "  Rarity < 20 → Bronze Athena"
echo "  Total combinations: 262,144 (4^9 seed-based)"
echo ""
echo "To mint NFT:"
echo "  cast send 0x4F541D6f6249deAE5cDa2B00625d6933E4943b3c \\"
echo "    'mintTest(address,uint8)' \\"
